...
Sea X una variable aleatoria normal con parámetros mu=1 y sigma=1. Calculad el valor de b tal que P((X-1)\^2\<= b)=0.1.

## 5

Sea Z una variable aleatoria N(0,1). Calcular P((Z-1/4)\^2 \>1/16).
