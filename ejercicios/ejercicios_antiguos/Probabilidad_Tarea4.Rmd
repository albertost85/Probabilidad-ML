...
\[\Omega = 4^3\] ### Suceso: todas las cartas son rojas A = {RRR} ### Suceso: Una carta roja, una verde y una azul B={ RAV RVA ARV VRA VRA ARV } ### Suceso: cartas de colores distintos C = { RAN RAV RNA RNV RVA RVN ARN ARV NRA NRV VRA VRN NRA VRA ARN VRN ARV NRV ANV AVN NAV VAN NVA VAN}
...
\[ P({1}) + P({2}) + P({3}) + P({4}) + P({5}) + P({6}) = 1 \\ P({2}) = 2P({1}) \\ P({3}) = 3P({1}) \\ P({4}) = 4P({1}) \\ P({5}) = 5P({1}) \\ P({6}) = 6P({1}) \\ \]

\[ 21P({1}) = 1 \]

\[ \begin{matrix} P({1}) = 1/21 \\ P({2}) = 2/21 \\ P({3}) = 3/21 \\ P({4}) = 4/21 \\ P({5}) = 5/21 \\ P({6}) = 6/21 \\ P({2,4,6}) = 12/21 \\ P({1,3,5}) = 9/21 \\ \end{matrix} \]

Probabilidad sucesos elementales, probabilidad inversamente proporcional
\[ P({1}) + P({2}) + P({3}) + P({4}) + P({5}) + P({6}) \\ P({2}) = P({1})/2 \\ P({3}) = P({1})/3 \\ P({4}) = P({1})/4 \\ P({5}) = P({1})/5 \\ P({6}) = P({1})/6 \\ \]

\[ \frac{49}{20}P({1}) = 1 \] \[ \begin{matrix} P({1}) = 20/49 \\ P({2}) = 10/49 \\ P({3}) = 20/147 \\ P({4}) = 5/49 \\ P({5}) = 4/49 \\ P({6}) = 10/147 \\ P({2,4,6}) = 55/145 \\ P({1,3,5}) = 92/147 \\ \end{matrix} \]
...
Variaciones con repetición de 26 letras tomadas 3 a 3, y 10 dígitos tomados 3 a 3 VR(26,3) * (VR(10,3) = 26^3 * 10^3 = 175760000 matrículas.
...
Permutaciones con repetición de 20 elementos, en grupos de 10 y 10 PR(20,10,10) = 20!/(10!10!) = 184756
